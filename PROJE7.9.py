...
class Thermostat(Appliance):
    def __init__(self, name):
        super().__init__(name)
        self.temperature = 22  # Başlangıç sıcaklığı
...
if __name__ == "__main__":
    ...
    smart_home.add_appliance(Thermostat("Banyo Termostatı"))
    smart_home.add_appliance(SecuritySystem("Ana Kapı Güvenlik Sistemi"))
